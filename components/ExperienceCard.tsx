  ...
  return (
    ...
    duration-200 overflow-hidden">
            ...
            <div className="px-0 md:px-10">
                <h4 className="text-4xl font-light"> CEO OF YOUR MOTHER</h4>
                <p className="font-bold text-2xl mt-1">FUCK YOU</p>
                ...
                <ul className="list-disc space-y-4 ml-5 text-lg h-96 w-4/5 overflow-y-scroll
